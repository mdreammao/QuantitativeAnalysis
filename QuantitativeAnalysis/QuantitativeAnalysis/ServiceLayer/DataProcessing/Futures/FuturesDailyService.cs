...
namespace QuantitativeAnalysis.ServiceLayer.DataProcessing.Futures
{
    ...
    {
        public override List<FuturesDaily> getLocalCSVResult(String path)
        {
            return Platforms.container.Resolve<FuturesDailyFromLocalCSVRepository>().readFromLocalCSV(path);
        }

        public override List<FuturesDaily> getWindResult(string code, DateTime date1, DateTime date2, string tag = null, IDictionary<string, object> options = null)
        {
